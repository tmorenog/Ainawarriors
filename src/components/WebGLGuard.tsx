      ...
      <div className="absolute inset-0 grid place-items-center bg-forest-900 text-bone p-6 overflow-y-auto">
        <div className="max-w-md text-center my-auto">
          ...
          <p className="text-sm opacity-85 mb-4">
            Your browser couldn&rsquo;t open a 3D view yet. This is sometimes a quick hiccup right after
            the character creator closes &mdash; try the retry button first.
          </p>
          <ul className="text-xs opacity-80 text-left bg-black/30 rounded-lg p-3 mb-4 space-y-1">
            <li>&bull; <b>Safari (iPad / Mac):</b> Settings &rarr; Safari &rarr; Advanced &rarr; Experimental Features &rarr; enable <i>WebGL 2.0</i>.</li>
            <li>&bull; <b>Chrome / Edge:</b> Settings &rarr; System &rarr; enable <i>Use hardware acceleration</i>, then restart.</li>
            <li>&bull; <b>Firefox:</b> about:config &rarr; set <code>webgl.disabled</code> to false.</li>
            <li>&bull; Close other 3D tabs (the browser limits how many WebGL contexts can run at once).</li>
            <li>&bull; Try a different browser if you&rsquo;re on a private / locked-down profile.</li>
          </ul>
